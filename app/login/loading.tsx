    ...
    <main className="auth-shell auth-shell--portal xi-route-loading" aria-busy="true" aria-label="Đang tải">
      <div className="auth-panel" aria-hidden="true">
        <div className="auth-heading">
          <div className="xi-skel xi-skel-eyebrow" style={{ marginBottom: 10, width: 96 }} />
          <div className="xi-skel" style={{ height: 28, width: "70%", marginBottom: 10, maxWidth: 280 }} />
        ...
        <div className="xi-skel" style={{ height: 14, width: "55%", marginTop: 18, marginInline: "auto" }} />
      </div>
    </main>
  );
}
